pipeline {
    ...
    environment {
        ...
        TOMCAT_URL = 'http://16.170.227.174:9090/manager/text'
        TOMCAT_USER = 'admin'
        TOMCAT_PASS = 'admin'
    ...
    stages {
        stage('Clone Repository') {
            steps {
                git url: 'https://github.com/Bhanuvamsi2005/S207_FULLSTACK_P3.git', branch: 'master'
            }
        }
    ...
    post {
        success {
            echo "✅ Backend deployed: http://16.170.227.174:9090/springapp1"
            echo "✅ Frontend deployed: http://16.170.227.174:9090/frontapp1"
        }
        failure {
